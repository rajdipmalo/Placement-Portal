...
export default {
  ...
  data() {
    return {
      ...
      userRole: localStorage.getItem("role") || "company",
      showLogoutModal: false,
      showSessionExpiredModal: false,
      navItems: [
        { id: "home", label: "Home", icon: "bi bi-speedometer2", badge: null },
        { id: "drives", label: "My Drives", icon: "bi bi-briefcase", badge: null },
        { id: "applications", label: "Applications", icon: "bi bi-file-text", badge: null },
        { id: "create", label: "Create Drive", icon: "bi bi-plus-circle", badge: null },
        { id: "profile", label: "Profile", icon: "bi bi-person", badge: null }
      ],
  ...
  computed: {
    ...
    roleBadgeClass() {
      ...
      return classes[this.userRole] || 'badge-default';
    },
  ...
  watch: {
    '$route.path': {
      handler() {
        // Force re-evaluation of active tab when route changes
      },
      immediate: true
    }
  },
  ...
  methods: {
    isActiveTab(tabId) {
      ...
      switch(tabId) {
        ...
        case 'drives':
          // Only match exactly /company/dashboard/drives or /company/dashboard/drives/:id
          return path.startsWith('/company/dashboard/drives') && !path.includes('/create');
        case 'applications':
          return path.startsWith('/company/dashboard/applications');
        case 'create':
          return path === '/company/dashboard/create';
        case 'profile':
          return path === '/company/dashboard/profile';
        default:
          return false;
      }
    },
    ...
    navigateToTab(tabId) {
      ...
      switch(tabId) {
        ...
        case 'create':
          ...
          break;
        case 'profile':
          this.$router.push('/company/dashboard/profile');
          break;
      }
    },
    ...
    clearAuthData() {
      ...
      localStorage.removeItem("editingDrive");
