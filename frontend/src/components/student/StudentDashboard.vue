  ...
  <div class="dashboard-wrapper">
    ...
    <div class="dashboard-container d-flex">
        ...
        <nav class="nav-wrapper flex-grow-1 d-flex flex-column">
          <ul class="nav-list list-unstyled">
            <li
              ...
              @click="activeTab = item.id; $router.push(`/student/dashboard/${item.id === 'dashboard' ? '' : item.id}`)"
      ...
      <main class="content p-4 flex-grow-1">
        <router-view 
          ...
          @back-to-companies="goToCompanies"
        />
      </main>
    </div>
    ...
    <div v-if="showLogoutModal" class="modal-overlay" @click.self="closeLogoutModal">
      <div class="modal-content">
        ...
        <p class="text-white-50 mb-4">Are you sure you want to logout?</p>
    ...
    <div v-if="showSessionExpiredModal" class="modal-overlay" @click.self="redirectToLogin">
      <div class="modal-content">
        ...
        <p class="text-white-50 mb-4">Your session has expired. Please login again.</p>
        <div class="modal-actions d-flex gap-3 justify-content-end">
...
export default {
  ...
  data() {
    return {
      activeTab: this.$route.path.split('/').pop() || 'dashboard',
      userName: localStorage.getItem("userName") || "",
      userRole: localStorage.getItem("role") || "student",
      showLogoutModal: false,
      showSessionExpiredModal: false,
      navItems: [
        { id: "dashboard", label: "Dashboard", icon: "bi bi-speedometer2", badge: null },
        { id: "companies", label: "Companies", icon: "bi bi-building", badge: null },
        { id: "placements", label: "Placements", icon: "bi bi-trophy", badge: null },
  ...
  watch: {
    '$route'(to) {
      ...
      this.activeTab = path === 'dashboard' ? 'dashboard' : path;
    }
  },
